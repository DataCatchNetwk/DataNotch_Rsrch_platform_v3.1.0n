...
export default function UserLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-100/70 dark:bg-zinc-950 overflow-hidden">
        <div className="sticky top-0 z-40 bg-zinc-100/90 dark:bg-zinc-900 border-b border-zinc-200/70 dark:border-zinc-800 px-10 py-5 flex items-center justify-between backdrop-blur supports-backdrop-filter:bg-zinc-100/70">
          <div>
            <h1 className="text-[42px] leading-none font-bold tracking-tight">Dashboard</h1>
            <p className="text-muted-foreground">Welcome back! Here's an overview of your research workspace.</p>
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-115 hidden xl:block">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-zinc-500" />
              <input
                type="text"
                placeholder="Search studies, datasets, collaborators..."
                className="w-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl py-3 pl-11 pr-20 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
              />
            ...
            <Button variant="outline" className="hidden md:inline-flex rounded-xl gap-2 bg-white dark:bg-zinc-900 h-11 px-5">
            ...
            <Button className="hidden sm:inline-flex rounded-xl gap-2 bg-violet-600 hover:bg-violet-700 h-11 px-5">
        ...
        <div className="p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {stats.map((stat, i) => (
              <Card key={i} className="rounded-3xl border-zinc-200/70 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
                ...
                <CardContent className="pt-0">
                  <div className="text-4xl font-semibold mb-1 leading-none">{stat.value}</div>
                  <p className={`text-sm ${stat.color === 'amber' ? 'text-amber-600' : 'text-emerald-600'}`}>
                    {stat.trend}
                  </p>
                  <Button variant="link" className="h-auto p-0 mt-1 text-violet-600 hover:text-violet-700">
                    {stat.cta} →
                  </Button>
                </CardContent>
              </Card>
          ...
          <div className="grid lg:grid-cols-7 gap-6">
            ...
            <Card className="lg:col-span-5 rounded-3xl border-zinc-200/70 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
              <CardHeader>
            ...
            {/* Recent Activity */}
            <Card className="lg:col-span-2 rounded-3xl border-zinc-200/70 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
          ...
          <div className="grid lg:grid-cols-7 gap-6 mt-8">
            ...
            <Card className="lg:col-span-5 rounded-3xl border-zinc-200/70 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Button variant="outline" className="rounded-xl">View all studies</Button>
                  <Button
            ...
            <Card className="lg:col-span-2 rounded-3xl border-zinc-200/70 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
              ...
              <CardContent>
                <div className="border-2 border-dashed border-violet-300 dark:border-violet-800 rounded-2xl p-8 text-center hover:border-violet-500 transition bg-violet-50/40 dark:bg-violet-950/20">
                  <div className="h-10 w-10 mx-auto mb-3 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-violet-600">
                  ...
                  <Button variant="outline" className="w-full mt-2 rounded-xl bg-white dark:bg-zinc-900">

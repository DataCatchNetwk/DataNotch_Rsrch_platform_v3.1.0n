          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.optionsRow}>
              <label className={styles.checkbox}>
                <input type="checkbox" disabled={submitting} defaultChecked={true} />
            ...
            <button type="submit" className={styles.submitButton} disabled={submitting}>
              {submitting ? (
                ...
                <><span>Sign In</span><span className={styles.buttonArrow}>→</span></>
              )}
            </button>
          </form>
        ...
        <div className={styles.infoPanel}>
          <div className={styles.infoPanelContent}>
            ...
            <div className={styles.featureList}>
              <div className={styles.feature}><span className={styles.featureIcon}>✓</span><span>Role-Based Access Control</span></div>
              <div className={styles.feature}><span className={styles.featureIcon}>✓</span><span>Secure JWT Authentication</span></div>
              <div className={styles.feature}><span className={styles.featureIcon}>✓</span><span>Audit Logging</span></div>
              <div className={styles.feature}><span className={styles.featureIcon}>✓</span><span>Data Encryption</span></div>
            </div>
          </div>
        </div>
      </div>

      ...
      <div className="mx-auto grid h-[calc(100dvh-1rem)] w-full max-w-6xl grid-cols-1 items-stretch gap-3 lg:grid-cols-2 lg:gap-4">
        <div className="h-full overflow-y-auto rounded-3xl bg-white p-4 shadow-2xl md:p-5">
          ...
          {error && (
            ...
            <Button type="submit" disabled={hydrated ? loading || checkingNetwork || !networkAccessAllowed : false} className="h-12 w-full rounded-lg text-base">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              disabled={hydrated ? loading || !!ssoLoading || checkingNetwork || checkingSsoConfig || !networkAccessAllowed : false}
